...
```
### Missing Values
```{r missing_values, code_folding="hide", fig.height=3, fig.width=5}
...
### Outliers
```{r outliers, code_folding="hide", fig.height=3, fig.width=5}
...
### Distributions
```{r distributions, code_folding="hide", fig.height=3, fig.width=5}
...
```{r pca, code_folding="hide", fig.height=3, fig.width=5}
...
## 7. Appendix
```{r appendix, code_folding="hide", fig.height=15, fig.width=28}
